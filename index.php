    ...
    <main class="top_page">
        ...
        <div id="about__area" class="wrap">
            <section class="inner flex-start">
                <div class="txt-area" data-aos="fade-up" data-aos-duration="1500" data-aos-once="true">
                    <div class="title">
        ...
        <div id="time__area">
            <section class="inner">
                ...
                <p class="txt-16 txt-center txt-white" data-aos="fade-up" data-aos-duration="1500" data-aos-once="true">問診から施術まで１時間程度となります。</p>

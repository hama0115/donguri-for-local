<?php get_header(); ?>
    <main class="top_page">
        ...
        <div id="about__area" class="wrap">
            <section class="inner flex-start">
                <div class="txt-area">
                    <div class="title">
                        <p class="txt-14 en">About</p>
                        <h2 class="txt-24">カイロプラクティックとは？</h2>
                    </div>
                    <div class="txt">
                        <p class="txt-16">
                            背骨や骨盤などの骨格の歪みを手技によって調整し、身体の不調の改善や予防を目指す療法です。<br>
                            カイロプラクティックの施術のみで症状が“完全に回復する”とは限らず、多くの場合は生活習慣の見直しが根本改善のカギとなります。<br>
                            症状の内容に応じて、必要な栄養・睡眠・生活習慣の改善に関するアドバイスも行っております。<br>
            ...
            <section class="inner">
                ...
                <div class="price-box">
                    ...
                    <div class="txt">
                        ...
                        <p class="txt-48"><span class="en-a">4,400</span><span class="txt-20">円（税込）</span></p>
                    </div>
                </div>
                <div class="price-box">
...
皆さまの健やかな毎日のために、誠心誠意お手伝いさせていただきます。</p>
        ...
        <div id="calendar__area">
            <section class="inner">
                ...
                <p class="txt-16">ご予約はお電話、もしくは予約フォームより受け付けております。ご都合のよい日時をお選びください。</p>
                <div class="cntnt">
                    <table class="table">
                        <tr>
                    ...
                    <p class="txt-14">休診日：不定休</p>
                    <p class="txt-14">営業カレンダーは目安です。施術者の都合により、休みをいただく場合がございますのでご了承ください。また、時間に関しましては柔軟に対応可能です。「お問い合わせ」からご連絡ください。<br>当日予約はお電話で、明日以降はWEB予約が可能です。</p>
                </div>
                <div class="btn" data-aos="fade-up" data-aos-duration="1500" data-aos-once="true">
                    <a href="<?php echo get_permalink( get_page_by_path('form') ); ?>"><span class="txt-20 txt-white">WEB予約はこちら</span></a>
                    <a href="<?php echo get_permalink( get_page_by_path('contact') ); ?>"><span class="txt-20 txt-white">お問い合わせはこちら</span></a>
